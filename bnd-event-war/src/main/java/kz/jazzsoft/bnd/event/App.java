...
public class App extends ABaseApplication {
    ...
    public void init() { 
        ...
        getMainWindow().setContent(getView(MasterView.class));
        initUI(); 
        setTheme("bnd-event");
