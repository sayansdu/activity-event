...
import kz.jazzsoft.bnd.core.api.integration.CamelSender;
...
public class EventAdapter {
    ...
    @Autowired
    CamelSender camelSender = new CamelSender();
     ...
     */
    public void sendEvent(Type type, Long userId, String description, String moduleName, String componentName) {
