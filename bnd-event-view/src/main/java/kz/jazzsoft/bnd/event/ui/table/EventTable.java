...
public class EventTable{
     ...
     * And configure them
     */    
    public boolean removeEvent(final ABaseView app){
    	final Object target = filterTable.getValue();
    	if(target == null){
			app.getApplication().getMainWindow().showNotification(
			...
			app.getApplication().getMainWindow().addWindow(actionWindow);						
			cancel.addListener(new Button.ClickListener() {
				
				@Override
				public void buttonClick(ClickEvent event) {
					
					app.getApplication().getMainWindow().removeWindow(actionWindow);
				}
			});
    ...
    public void getEvent(final ABaseView app){
